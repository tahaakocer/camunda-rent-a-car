...
public class MNHKPSPublicSoap12
{
    ...
    public MNHKPSPublicSoap12()
    {
    }

    public MNHKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public MNHKPSPublicSoap12 (String url,MNHConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        MNHRequestResultHandler handler = new MNHRequestResultHandler(MNHSoapVersion.v1_2);
        return handler;
    }
